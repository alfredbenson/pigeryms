...
<div class="head-title">
  ...
  <i class='bx bx-plus-circle'></i> Add New
    ...
    <td style="padding-left: 40px; text-align: left;"><?php echo htmlentities($result->total_piglets);?></td>
    <td style="padding-left: 50px; text-align: left;"><?php echo htmlentities($result->survived); ?>
</td>
